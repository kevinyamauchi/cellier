...
#     """Affine transformation for scale to full resolution coordinate mapping.
#
#     This class represents a 4x4 affine transformation matrix that only supports
#     scale and translation operations (no rotation or shear). The transformation
#     maps coordinates from a scale level to the full resolution coordinate system.
#
#     Parameters
#     ----------
#     matrix : np.ndarray
#         A 4x4 affine transformation matrix. Must only contain scale and
#         translation components (no rotation or shear).
#
#     Attributes
#     ----------
#     matrix : np.ndarray
...
#     ------
#     ValueError
#         If the matrix is not 4x4 or contains rotation/shear components.
#     """
#
...
#
#         # Validate that matrix only contains scale and translation
#         # Check that off-diagonal elements (except translation) are zero
#         for i in range(3):
#             for j in range(3):
#                 if i != j and not np.isclose(matrix[i, j], 0):
#                     raise ValueError(
#                         "Matrix contains rotation or shear components. "
#                         "Only scale and translation are allowed."
#                     )
#
...
#             raise ValueError(
#                 f"Bottom row must be [0, 0, 0, 1], got {matrix[3, :]}"
#             )
#
...
#         """Get the scale factors from the transformation matrix.
#
#         Returns
#         -------
...
#         """
#         return (
#             float(self._matrix[0, 0]),
#             float(self._matrix[1, 1]),
#             float(self._matrix[2, 2])
#         )
#
#     @property
#     def translation(self) -> tuple[float, float, float]:
#         """Get the translation components from the transformation matrix.
#
#         Returns
#         -------
#         tuple[float, float, float]
...
#         """
#         return (
#             float(self._matrix[0, 3]),
#             float(self._matrix[1, 3]),
#             float(self._matrix[2, 3])
#         )
#
#     @classmethod
...
#         """Transform a point from scale coordinates to full resolution coordinates.
#
#         Parameters
#         ----------
#         point : np.ndarray
#             Point(s) to transform. Shape can be (3,) for a single point
#             or (N, 3) for multiple points.
#
#         Returns
#         -------
#         np.ndarray
#             Transformed point(s) in full resolution coordinates.
#             Same shape as input.
#         """
...
#         transformed = homogeneous @ self._matrix.T
#
