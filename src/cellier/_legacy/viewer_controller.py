...
from cellier._legacy.gui.constants import GuiFramework
from cellier._legacy.models.data_stores.base_data_store import BaseDataStore
from cellier._legacy.models.viewer import ViewerModel
from cellier._legacy.models.visuals.base import BaseVisual
from cellier._legacy.render import RenderManager
from cellier._legacy.render._render_manager import CanvasRedrawRequest
from cellier._legacy.slicer.slicer import (
    AsynchronousDataSlicer,
    SlicerType,
)
from cellier._legacy.slicer.utils import (
    world_selected_region_from_dims,
)
from cellier._legacy.types import SceneId, TilingMethod, VisualId
from cellier._legacy.utils.chunk import generate_chunk_requests_from_frustum
...
class CellierController:
    ...
    def _construct_canvas_widgets(self, viewer_model: ViewerModel, parent=None):
        ...
        if self.gui_framework == GuiFramework.QT:
            # make a Qt widget
            from cellier._legacy.gui.qt.utils import construct_qt_canvases_from_model
