"""Appearance controls specific to label visuals (anywidget).
...
class AnywidgetLabelsRenderModeCombo(AnywidgetChoice):
...
class AnywidgetSaltSpin(AnywidgetIntSpin):
...
class AnywidgetBackgroundLabelSpin(AnywidgetIntSpin):
