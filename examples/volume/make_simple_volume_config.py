...
image_store = ImageMemoryStore(data=volume_data, name="image store")
...
# make the scene
scene_3d = Scene(dims=dims_3d, visuals=[image_visual_3d], canvases=[canvas_3d])
...
viewer_model.to_json_file("simple_volume_example_config.json")
